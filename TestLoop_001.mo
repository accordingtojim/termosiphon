...
model TestLoop_001
  ...
  ThermoPower.Water.SourcePressure src(p0 = 101325 + 4000)  annotation(
...
equation
  ...
  connect(HeatSrc.wall, evap.wall) annotation(
    Line(points = {{-70, -7}, {-70, 6}}, color = {255, 127, 0}));
  connect(Pheat.y, HeatSrc.power) annotation(
    Line(points = {{-99, -30}, {-70, -30}, {-70, -14}}, color = {0, 0, 127}));
  ...
  connect(Tsink.y, TempSnk.temperature) annotation(
    Line(points = {{-98, -50}, {-30, -50}, {-30, -34}}, color = {0, 0, 127}));
